...
variable "gatekeeper_helm_release_name" {
    type        = string
    default     = "gatekeeper-release"
}

variable "k8_proxy_helm_release_name" {
    type        = string
    default     = "k8-proxy-release-release"
}
...
variable "maintetenance_recurrence" {
    type = string
    default = "FREQ=WEEKLY;BYDAY=SA,SU"
}

variable "maintetenance_start_time" {
    type = string
    default = "2021-09-25T23:00:00Z"
}

variable "maintetenance_end_time" {
    type = string
    default = "2021-09-25T05:00:00Z"
}
